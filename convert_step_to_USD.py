...
from step_convert.usd_converter import convert_hierarchical_shape_to_usd
from step_convert.utils import print_component_metadata_report, count_shapes_in_hierarchy


def main(step_path=None, usd_path=None):
    ...
    try:
        ...
        print("Warning: Falling back to simple shape reading...")
...
if __name__ == "__main__":
    step_file = "./test_inputs/MK10.STEP"
    #step_file = "./test_files/test.STEP"
    usd_file = "./output/output.usda"
